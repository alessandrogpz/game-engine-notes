...
Now it becomes a [[01_Linear_Systems|linear system]] of type:
...
<center>
	<img src="../../98_Assets/Concepts/intersection_three_planes_parallel_lines.webp" width="360" height="235" alt="Three Planes Meeting in Three Parallel Lines">
</center>
...
<center>
	<img src="../../98_Assets/Concepts/intersection_three_planes_common_line.webp" width="360" height="238" alt="Three Planes Sharing a Common Line">
</center>

> [!NOTE]
> $\det \mathbf{A}$ is exactly the [[05_Scalar_Triple_Product|scalar triple product]] $[\mathbf{n}_1, \mathbf{n}_2, \mathbf{n}_3] = \mathbf{n}_1 \cdot (\mathbf{n}_2 \times \mathbf{n}_3)$, which measures the **volume of the parallelepiped** spanned by the three normals. A volume of zero means the three normals are coplanar — they no longer span 3D space, and so they cannot pin down a single point in it.
...
The order of the factors in each cross product has been **reversed** to cancel the minus sign. This works because the [[04_Cross_Product|cross product]] is anti-commutative:
...
* **C++ Source Code:** [[03_Code/05_Geometry/Intersection_Three_Planes.cppm|Intersection_Three_Planes.cppm]]
