...
1. Explain why linear independence of $\mathbf{n}_1$, $\mathbf{n}_2$ and $\mathbf{n}_3$ is exactly the condition needed for a unique intersection point. Relate your answer to the [determinant](../../../01_Concepts/03_Matrices/03_Determinants.md) of $\mathbf{A}$ and to the [scalar triple product](../../../01_Concepts/02_Vectors/05_Scalar_Triple_Product.md) interpreted as a volume.
2. In the derivation, $\mathbf{b} = (-d_1, -d_2, -d_3)$ carries a minus sign on every component. Show how reversing the operand order of each cross product absorbs that sign, and state which algebraic property of the [cross product](../../../01_Concepts/02_Vectors/04_Cross_Product.md) makes this legal.
...
4. The normals forming the rows of $\mathbf{A}$ are not required to be unit length for this calculation. Explain why, and contrast this with the [point-plane distance](../../../01_Concepts/05_Geometry/05_Distance_Point_and_Plane.md). What happens numerically as $[\mathbf{n}_1, \mathbf{n}_2, \mathbf{n}_3]$ approaches — but does not equal — zero, and what should a robust implementation do about it?

---
**Check Answer:** [S_08_Intersection_Three_Planes](../Solutions/S_08_Intersection_Three_Planes.md) | **Related Concepts:** [08_Intersection_Three_Planes](../../../01_Concepts/05_Geometry/08_Intersection_Three_Planes.md)
