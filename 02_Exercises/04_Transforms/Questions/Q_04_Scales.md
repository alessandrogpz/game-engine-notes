...
1. **[Determinant](../../../01_Concepts/03_Matrices/03_Determinants.md) of Scaling:** Explain geometrically why the determinant of the arbitrary scaling matrix $\mathbf{M}_{\text{scale}}(s, \vec{a})$ is exactly $s$.
...
**Check Answer:** [S_04_Scales](../Solutions/S_04_Scales.md) | **Related Concepts:** [04_Scales](../../../01_Concepts/04_Transforms/04_Scales.md)
