...
$$
    ...
    Using matrix notation for the [dot product](../../../Concepts/02_Vectors/02_Dot_Product.md) of $3 \times 1$ column vectors $\vec{v}$ and $\vec{a}$:
...
This yields the complete [transformation matrix](../../../Concepts/04_Transforms/01_Transformation_Matrices.md):
...
This perfectly matches the [matrix multiplication](../../../Concepts/03_Matrices/02_Matrix_Multiplication.md) result from Step 2!
...
*   **Geometric Representation of the [Determinant](../../../Concepts/03_Matrices/03_Determinants.md):**
...
*   **Relationship to Projections:**
    This matrix is exactly the **Orthogonal Rejection Matrix** (often denoted as $\text{Rej}_{\vec{a}}\vec{v} = \mathbf{I} - \vec{a}\vec{a}^T$). Geometrically, it represents an orthogonal projection onto the plane perpendicular to the [normal vector](../../../Concepts/05_Geometry/02_Normal_Vectors.md) $\vec{a}$:
...
**Back to Question:** [Q_04_Scales](../Questions/Q_04_Scales.md) | **Related Concepts:** [04_Scales](../../../Concepts/04_Transforms/04_Scales.md)
