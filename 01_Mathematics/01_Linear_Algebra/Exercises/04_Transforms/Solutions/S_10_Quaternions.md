...
- **Calculation of $q_1 q_2$:**
  First, compute the vector [dot product](../../../Concepts/02_Vectors/02_Dot_Product.md) $\vec{v}_1 \cdot \vec{v}_2$:
  
$$
\vec{v}_1 \cdot \vec{v}_2 = 2(-1) + (-1)(2) + 1(-1) = -2 - 2 - 1 = -5
$$
  
  Next, compute the vector [cross product](../../../Concepts/02_Vectors/04_Cross_Product.md) $\vec{v}_1 \times \vec{v}_2$:
...
---
**Back to Question:** [Q_10_Quaternions](../Questions/Q_10_Quaternions.md) | **Related Concepts:** [10_Quaternions](../../../Concepts/04_Transforms/10_Quaternions.md)
