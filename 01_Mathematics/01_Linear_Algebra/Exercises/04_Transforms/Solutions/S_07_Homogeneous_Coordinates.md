...
*   **Comparison of $\vec{a}_h$ and $\vec{b}_h$:** Both vectors represent the **same point** in 3D Euclidean space, because after homogeneous division they project to the exact same coordinates:

$$
\begin{bmatrix} 2 & -4 & 6 \end{bmatrix}^T
$$
...
---
**Back to Question:** [Q_07_Homogeneous_Coordinates](../Questions/Q_07_Homogeneous_Coordinates.md) | **Related Concepts:** [07_Homogeneous_Coordinates](../../../Concepts/04_Transforms/07_Homogeneous_Coordinates.md)
