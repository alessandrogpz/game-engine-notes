...
$$
   ...
   * Normalize $\vec{u}_{\text{raw}}$ to find the unit vector $\vec{u}$ that can be used in a unit [quaternion](../../../Concepts/04_Transforms/10_Quaternions.md) rotation.

---
**Check Answer:** [S_09_Quaternion_Intuition](../Solutions/S_09_Quaternion_Intuition.md) | **Related Concepts:** [09_Quaternion_Intuition](../../../Concepts/04_Transforms/09_Quaternion_Intuition.md)
