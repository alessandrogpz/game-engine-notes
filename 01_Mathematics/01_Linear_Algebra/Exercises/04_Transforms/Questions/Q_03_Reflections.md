...
1.  **[Determinant](../../../Concepts/03_Matrices/03_Determinants.md) Intuition:** Calculate the determinants $\det\big(\mathbf{M}_{\text{reflect}}(\vec{a})\big)$ and $\det\big(\mathbf{M}_{\text{invol}}(\vec{a})\big)$ for the matrices you constructed in Part 1. Explain the geometric significance of their signs ($+1$ vs. $-1$) in 3D space.
...
---
**Check Answer:** [S_03_Reflections](../Solutions/S_03_Reflections.md) | **Related Concepts:** [03_Reflections](../../../Concepts/04_Transforms/03_Reflections.md)
