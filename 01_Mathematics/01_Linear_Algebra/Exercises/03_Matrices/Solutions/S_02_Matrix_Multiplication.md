...
We start with a 2D point at $(2, 1)$, represented in [homogeneous coordinates](../../../Concepts/04_Transforms/07_Homogeneous_Coordinates.md) as:
...
Since operations are applied right-to-left ($\vec{p}' = \mathbf{T}\mathbf{R}\mathbf{S}\vec{p}$), the combined [transformation matrix](../../../Concepts/04_Transforms/01_Transformation_Matrices.md) is:
...
*   The absolute value of the [determinant](../../../Concepts/03_Matrices/03_Determinants.md) ($|\det(\mathbf{M})|$) represents the **area scaling factor** of the transformation on 2D shapes. Here, the scale factor is 3 in both directions, meaning the area scales by a factor of $3^2 = 9$.
...
**Back to Question:** [Q_02_Matrix_Multiplication](../Questions/Q_02_Matrix_Multiplication.md) **Related Concepts:** [02_Matrix_Multiplication](../../../Concepts/03_Matrices/02_Matrix_Multiplication.md)