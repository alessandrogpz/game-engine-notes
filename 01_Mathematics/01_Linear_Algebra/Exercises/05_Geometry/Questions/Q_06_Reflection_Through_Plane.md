...
1. A plane is defined by the non-normalized 4D vector $\mathbf{f} = [1, 2, 2, -6]$, and a point is given as $\mathbf{p} = (3, 3, 3)$:
   ...
   * Calculate the [signed perpendicular distance](../../../Concepts/05_Geometry/05_Distance_Point_and_Plane.md) $\mathbf{f}_{\text{norm}} \cdot \mathbf{p}$.
...
4. Show that reflecting a point twice returns the original point ($\mathbf{H}_{\text{reflect}}^2 = \mathbf{I}_4$). What is $\det(\mathbf{H}_{\text{reflect}})$, and how does that value connect to the sign correction $\text{sign}(\det(\mathbf{M}))$ required when transforming [normal vectors](../../../Concepts/05_Geometry/02_Normal_Vectors.md) through a reflection?

---
**Check Answer:** [S_06_Reflection_Through_Plane](../Solutions/S_06_Reflection_Through_Plane.md) | **Related Concepts:** [06_Reflection_Through_Plane](../../../Concepts/05_Geometry/06_Reflection_Through_Plane.md)
