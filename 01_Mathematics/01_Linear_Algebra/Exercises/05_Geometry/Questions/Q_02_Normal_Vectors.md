...
3. If instead this face were transformed by the reflection $\mathbf{M} = \text{diag}(1, -1, 1)$, would the $\text{sign}(\det(\mathbf{M}))$ correction described in [02_Normal_Vectors](../../../Concepts/05_Geometry/02_Normal_Vectors.md) be necessary? Justify your answer using $\det(\mathbf{M})$.

---
**Check Answer:** [S_02_Normal_Vectors](../Solutions/S_02_Normal_Vectors.md) | **Related Concepts:** [02_Normal_Vectors](../../../Concepts/05_Geometry/02_Normal_Vectors.md)
