...
A plane has a known point $\mathbf{q} = (2, -1, 4)$ lying on its surface and [normal vector](../../../Concepts/05_Geometry/02_Normal_Vectors.md) $\mathbf{n} = \langle 2, 3, -1 \rangle$:
...
Convert $\mathbf{p}_1$ to 4D [homogeneous coordinates](../../../Concepts/04_Transforms/07_Homogeneous_Coordinates.md) by appending $1$ ($\mathbf{p}_{1,\text{4D}} = [1, 2, 2, 1]$), and evaluate the 4D [dot product](../../../Concepts/02_Vectors/02_Dot_Product.md):
...
**Back to Question:** [Q_04_Planes](../Questions/Q_04_Planes.md) | **Related Concepts:** [04_Planes](../../../Concepts/05_Geometry/04_Planes.md)
