...
Computing the face normal using the [cross product](../../../Concepts/02_Vectors/04_Cross_Product.md):
...
Checking the [dot product](../../../Concepts/02_Vectors/02_Dot_Product.md) of $\hat{n}_B$ with both transformed edge vectors:
...
* To correct for this, we must include the sign of the [determinant](../../../Concepts/03_Matrices/03_Determinants.md):
...
**Back to Question:** [Q_02_Normal_Vectors](../Questions/Q_02_Normal_Vectors.md) | **Related Concepts:** [02_Normal_Vectors](../../../Concepts/05_Geometry/02_Normal_Vectors.md)
