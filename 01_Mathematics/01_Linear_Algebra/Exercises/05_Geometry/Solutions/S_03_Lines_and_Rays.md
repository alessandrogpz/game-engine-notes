...
Compute the [cross product](../../../Concepts/02_Vectors/04_Cross_Product.md) $\mathbf{u} \times \mathbf{v}$:
...
Inverting the matrix yields the [determinant](../../../Concepts/03_Matrices/03_Determinants.md) in the denominator:
...
**Back to Question:** [Q_03_Lines_and_Rays](../Questions/Q_03_Lines_and_Rays.md) | **Related Concepts:** [03_Lines_and_Rays](../../../Concepts/05_Geometry/03_Lines_and_Rays.md)
