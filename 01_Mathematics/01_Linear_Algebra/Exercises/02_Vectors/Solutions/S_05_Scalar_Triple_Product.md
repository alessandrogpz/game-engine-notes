...
*   **Geometric reasoning**: The [cross product](../../../Concepts/02_Vectors/04_Cross_Product.md) $\vec{u} \times \vec{v}$ yields a [normal vector](../../../Concepts/05_Geometry/02_Normal_Vectors.md) perpendicular to the plane of $\vec{u}$ and $\vec{v}$. If the [dot product](../../../Concepts/02_Vectors/02_Dot_Product.md) of this normal vector and $\vec{w}$ is $0$, then $\vec{w}$ is orthogonal to the normal vector, meaning $\vec{w}$ must lie within the plane spanned by $\vec{u}$ and $\vec{v}$.

### 2. Matrix Determinant Equivalence
Calculating the scalar triple product is completely equivalent to calculating the [determinant](../../../Concepts/03_Matrices/03_Determinants.md) of the $3 \times 3$ matrix whose rows (or columns) are the three vectors:
...
---
**Back to Question:** [Q_05_Scalar_Triple_Product](../Questions/Q_05_Scalar_Triple_Product.md) | **Related Concepts:** [05_Scalar_Triple_Product](../../../Concepts/02_Vectors/05_Scalar_Triple_Product.md)