...
This method calculates the inverse of a matrix algebraically using the **matrix of cofactors** ([determinants](03_Determinants.md)) and its transpose, the **adjugate matrix**. It is particularly useful for $2 \times 2$ and $3 \times 3$ matrices and is the basis of Cramer's Rule.
...
*   **C++ Source Code:** [Matrix_Inversion.cppm](../../../../90_Code/03_Matrices/Matrix_Inversion.cppm)
