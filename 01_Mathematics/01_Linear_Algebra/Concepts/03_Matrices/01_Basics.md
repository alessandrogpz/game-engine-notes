...
$$
A = \begin{bmatrix} a & b & c \\\\ d & e & f \end{bmatrix} \quad \implies \quad A^T = \begin{bmatrix} a & d \\\\ b & e \\\\ c & f \end{bmatrix}
$$
...
*   **C++ Source Code:** [Basics.cppm](../../../../90_Code/03_Matrices/Basics.cppm)
