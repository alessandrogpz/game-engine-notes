...
<center>
	<img src="../../Assets/normal_vector_triangle.webp" width="300" height="300" alt="Calculating Normal Vector of a Triangle">
</center>
...
<center>
	<img src="../../Assets/normal_vector_shear.webp" width="650" height="300" alt="Shearing Normal Vector">
</center>

As we can see, neither the original normal $\mathbf{n}$ nor $\mathbf{M}\mathbf{n}$ is orthogonal to the sheared edge.
...
$$
\mathbf{n}_B = \mathbf{M} \mathbf{n}_A
$$
...
* **C++ Source Code:** [Normal_Vectors.cppm](../../../../90_Code/05_Geometry/Normal_Vectors.cppm)
